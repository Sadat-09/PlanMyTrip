...
function book($roomtype, $location) {
    $con = getConnection();
    $sql = "select room_id, hotel_name, room_type, location, date,Price from rooms where   room_type='{$roomtype}' and location='{$location}' and Status!='Unavailable'";
...
function updatestatus($id){
    $con = getConnection();
    $sql = "UPDATE rooms SET Status='Unavailable' WHERE room_id = $id;";
    $result = mysqli_query($con, $sql);
    return;
